...
export const MONSTERS: Monster[] = [
    ...
    { id: 'mA', name: 'おおねずみ', maxHp: 35, emoji: '🐭', color: 'from-gray-400 to-gray-600', expReward: 18, pointReward: 18, attackPower: 7 },
    ...
    { id: 'mB', name: 'はぐれおおかみ', maxHp: 55, emoji: '🐺', color: 'from-slate-400 to-slate-700', expReward: 30, pointReward: 30, attackPower: 12 },
    ...
    { id: 'mC', name: 'いかりのいのしし', maxHp: 70, emoji: '🐗', color: 'from-orange-700 to-orange-900', expReward: 35, pointReward: 35, attackPower: 16 },
    ...
    { id: 'mD', name: 'かえんのたま', maxHp: 65, emoji: '🔥', color: 'from-red-500 to-orange-500', expReward: 40, pointReward: 35, attackPower: 18 },
    { id: 'm12', name: 'どろにんぎょう', maxHp: 45, emoji: '💩', color: 'from-amber-600 to-amber-800', expReward: 20, pointReward: 15, attackPower: 5 },
    { id: 'm13', name: 'みならいまほうつかい', maxHp: 60, emoji: '🧙', color: 'from-purple-400 to-pink-500', expReward: 45, pointReward: 45, attackPower: 18 },
    { id: 'mE', name: 'うごくいしぞう', maxHp: 100, emoji: '🗽', color: 'from-emerald-600 to-teal-800', expReward: 50, pointReward: 45, attackPower: 12 },
    ...
    { id: 'mF', name: 'くらやみのきし', maxHp: 130, emoji: '🥷', color: 'from-gray-700 to-black', expReward: 70, pointReward: 60, attackPower: 22 },
    ...
    { id: 'mG', name: 'まかいのおう', maxHp: 250, emoji: '👿', color: 'from-red-900 to-black', expReward: 150, pointReward: 120, attackPower: 45 },
    { id: 'm20', name: 'でんせつの どらごん', maxHp: 300, emoji: '🐉', color: 'from-amber-300 to-orange-600', expReward: 200, pointReward: 150, attackPower: 50 },
    { id: 'mH', name: 'うちゅうからの しんりゃくしゃ', maxHp: 400, emoji: '👽', color: 'from-green-400 to-cyan-500', expReward: 300, pointReward: 250, attackPower: 60 },
];
